...
class DataTrainingArguments:
    ...
    dataset_name: str = field(default='pile',
    ...
    do_padding: bool = field(default=False,
                             metadata={"help": "Pad the inputs."})
    add_domain_id: bool = field(
        default=False,
        metadata={
            "help":
            "Add domain id to examples (when it's not already in the data)."
        })
...
class FullTrainingArguments(TrainingArguments):
    ...
    reweight_domains: bool = field(default=False,
                                   metadata={"help": "Do reweighting."})
    ...
    doremi_optimizer: str = field(default='doremiv1',
                                  metadata={"help": "Optimizer for DoReMi."})
    ...
    lr_scheduler_name: str = field(
        ...
        metadata={
            "help":
            "Custom LR scheduler name (linear_warmup_exponential, linear_warmup_cosine)"
        })
    train_domain_weights_tmp_file: str = field(
        default=None,
        metadata={
            "help": "Path to the temporary file for training domain weights."
        })
...
def main():
    ...
    if training_args.do_eval:
        ...
        def compute_metrics(eval_prediction):
            ...
            for domain_idx in data_args.num_domains:
                ...
                domain_metrics = metric.compute(predictions=domain_preds,
                                                references=domain_labels)
    ...
    training_args.ddp_find_unused_parameters = False  # Think I can keep as ddp but maybe need ddp
    ...
    trainer = DoReMiTrainer(
        ...
        tokenizer=tokenizer,
        data_collator=data_utils.get_data_collator(tokenizer, eos_token_id=0),
