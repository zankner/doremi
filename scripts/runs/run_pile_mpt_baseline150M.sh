...
#
# Sample baseline model run of a 150M model with the same number of non-embedding parameters as the 150M model in the DoReMi paper. Not the same as DoReMi paper since the paper uses 256k vocab size.
#
...
NAME=complete_replicate_pile_neox_baseline_150M_50kvocab
accelerate launch \
    ...
    --do_train \
    --cache_dir ${CACHE} \
    --domain_config_path configs/pile_baseline_neox_50kvocab.json \
